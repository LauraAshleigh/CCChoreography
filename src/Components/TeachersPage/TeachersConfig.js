...
const teachers = [
  {
    ...
    + 'at local eisteddfods arounds Newcastle.'
    
    + '<br><br><b>Eisteddfod Troupe Awards:</b>'
    + '<br><br>'
    + '<div class="awards-grid">'
    + '<div>'
    + '<b>Live to Dance Ultimate Challenge 2018:</b>'
    ...
    + '<br>Highest Score Award for Senior Troupe'
    + '<br>1st - Contemporary 12&U Duo'
    + '<br>1st - Musical Theatre 12&U Solo'
    + '<br>1st - Lyrical 12&U Solo'
    + '<br>2nd - Jazz 12&U Solo'
    + '</div>'
    
    + '<div>'
    + '<b>Shine Bright Dance Challenge 2019:</b>'
    + '<br>1st - Lyrical Troupe 14&U'
    + '<br>2nd - Jazz Troupe 14&U'
    + '<br>3rd - Contemporary Troupe 14&U'
    + '<br>3rd - Contemporary Troupe 12&U'

    + '<br><br><b>View Dance Challenge 2019:</b>'
    + '<br>Gold Award - 12&U Soloist'
    + '<br>Special Award - ‘Great Story Telling’ Soloist'
    + '<br>Gold Award - 10&U Soloist'

    + '<br><br><b>Live To Dance Ultimate Challenge 2019:</b>'
    + '<br>1st - Speed Tap Soloist'
    + '<br>2nd - Musical Theatre Soloist'
    + '<br>2nd - 14&U Jazz Troupe'
    + '</div>'
    + '</div>'
    + '<br><br>'

    + 'Chelsea has performed both competitively for many years and commercially for corporate and charity events:'
    + '<ul class="performance-list">' 
    + '<li>Performed at Newcastle, Mattara & Riverlights Multicultural Festivals</li>'
    + '<li>Participated in numerous charity events; Hunter Churches NSW, Prostate Cancer Charity Ball, '
    + 'Raising Awareness for Multicultural Backgrounds and Giggle Charity Ball, to name a few.</li>'
    + '<li>Stage Dancer for local singers, The Damn Good Divas & Elephant Man, while they were on tour.</li>'
    + '<li>Can Can Performer at Newcastle Restaurants and Great Gatsby Theme Dancer at Newcastle City Hall.</li>' 
    + '</ul>'
  },
  {
    name: 'Miss Bella',
